...
public abstract class EDIInputFactory extends PropertySupport {
    ...
    /**
     * Creates a new {@link XMLStreamReader} that uses the given reader as its data source.
     * The reader should be positioned before the start of an interchange or at the start of
     * an interchange.
     *
     * XML generated by the XMLStreamReader consist exclusively of elements in the namespaces
     * declared by the constants in {@link EDINamespaces}. The names of the elements will be as
     * follows:
     *
     * <table>
     ...
     *   <td>Segment tag plus two digit element position from EDI data plus hyphen plus two digit component position</td>
     *   <td>{@link EDINamespaces#ELEMENTS}</td>
     * </tr>
     * </table>
     *
     * Errors encountered in the EDI data will result in an XMLStreamException with a message
