...
public enum State {
	...
	/*private static final State HA = State.HEADER_TAG_A;
	private static final State HB = State.HEADER_TAG_B;*/
	...
	private static final State TRANSITION_TABLE[][] = {
		//TODO decimal for EDIFACT
		//TODO A/B -> interchange begin (don't wait for element delim.
		/*-
